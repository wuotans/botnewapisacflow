...
class MyBot(BotWeb):
    ...
    def fetch_data_from_api(self, url, querystring, headers):
...
if __name__ == '__main__':
    with MyBot() as mybot:
        ...
        querystring = {"startDate": "2025-02-10", "endDate": "2025-02-10"}
        headers = {
        ...
        data = mybot.fetch_data_from_api(url, querystring, headers)
